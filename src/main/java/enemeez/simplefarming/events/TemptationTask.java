...
public class TemptationTask {
	...
	private static final Ingredient SEEDS = Ingredient.fromItems(ModItems.cantaloupe_seeds, ModItems.carrot_seeds,
			ModItems.cassava_seeds, ModItems.corn_seeds, ModItems.cucumber_seeds, ModItems.eggplant_seeds,
			ModItems.honeydew_seeds, ModItems.kenaf_seeds, ModItems.lettuce_seeds, ModItems.oat_seeds,
			ModItems.onion_seeds, ModItems.potato_seeds, ModItems.pepper_seeds, ModItems.radish_seeds,
			ModItems.rice_seeds, ModItems.rye_seeds, ModItems.soybean_seeds, ModItems.spinach_seeds,
