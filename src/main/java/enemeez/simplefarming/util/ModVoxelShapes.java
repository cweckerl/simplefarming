...
public class ModVoxelShapes
{
    ...
    public static final VoxelShape[] SMALL_CROP_SHAPES_0_7 = new VoxelShape[]{
            CROP_SHAPE_0,
    ...
    public static final VoxelShape[] SMALL_CROP_SHAPES_0_3 = new VoxelShape[]{CROP_SHAPE_0, CROP_SHAPE_2, CROP_SHAPE_4, CROP_SHAPE_6};
    ...
    public static final VoxelShape[] GOURD_SHAPES_0_7 = new VoxelShape[]{
            CROP_SHAPE_0,
            GOURD_SHAPE_1, GOURD_SHAPE_1, GOURD_SHAPE_1,
            GOURD_SHAPE_2, GOURD_SHAPE_2, GOURD_SHAPE_2,
