...
public class ModBlocks {
	...
	public static void registerAll(RegistryEvent.Register<Block> event) {
		...
		apricot_sapling = register("apricot_sapling", new CustomSapling(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0f).sound(SoundType.PLANT), 2));
		banana_sapling = register("banana_sapling", new CustomSapling(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0f).sound(SoundType.PLANT), 3));
		cherry_sapling = register("cherry_sapling", new CustomSapling(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0f).sound(SoundType.PLANT), 7));
		mango_sapling = register("mango_sapling", new CustomSapling(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0f).sound(SoundType.PLANT), 8));
		olive_sapling = register("olive_sapling", new CustomSapling(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0f).sound(SoundType.PLANT), 9));
		orange_sapling = register("orange_sapling", new CustomSapling(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0f).sound(SoundType.PLANT), 5));
		pear_sapling = register("pear_sapling", new CustomSapling(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0f).sound(SoundType.PLANT), 6));
		plum_sapling = register("plum_sapling", new CustomSapling(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0f).sound(SoundType.PLANT), 4));

		apple_leaves = register("apple_leaves", new FruitLeaves(Block.Properties.create(Material.LEAVES)
				.hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT), "apple"));
		apricot_leaves = register("apricot_leaves", new FruitLeaves(Block.Properties.create(Material.LEAVES)
				.hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT), "apricot"));
		banana_leaves = register("banana_leaves", new FruitLeaves(Block.Properties.create(Material.LEAVES)
				.hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT), "banana"));
		cherry_leaves = register("cherry_leaves", new FruitLeaves(Block.Properties.create(Material.LEAVES)
				.hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT), "cherries"));
		mango_leaves = register("mango_leaves", new FruitLeaves(Block.Properties.create(Material.LEAVES)
				.hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT), "mango"));
		olive_leaves = register("olive_leaves", new FruitLeaves(Block.Properties.create(Material.LEAVES)
				.hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT), "olive"));
		orange_leaves = register("orange_leaves", new FruitLeaves(Block.Properties.create(Material.LEAVES)
				.hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT), "orange"));
		pear_leaves = register("pear_leaves", new FruitLeaves(Block.Properties.create(Material.LEAVES)
				.hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT), "pear"));
		plum_leaves = register("plum_leaves", new FruitLeaves(Block.Properties.create(Material.LEAVES)
		...
		birthday_cake = register("birthday_cake", new BirthdayCake(Block.Properties.create(Material.CAKE)
		...
		grape_plant = register("grape_plant", new GrapePlant((Block.Properties.create(Material.PLANTS).tickRandomly()
				.hardnessAndResistance(2.0F).sound(SoundType.WOOD))));
		...
		blackberry_bush = register("blackberry_bush",
				new CustomBush((Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement()
		...
		squash_crop = register("squash_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.STEM), "squash"));

		cactus_crop = register("cactus_crop", new CustomCactus((Block.Properties.create(Material.PLANTS).tickRandomly()
				.hardnessAndResistance(0.2f).sound(SoundType.CLOTH))));

		barley_crop = register("barley_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "barley"));

		broccoli_crop = register("broccoli_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "broccoli"));

		cantaloupe_crop = register("cantaloupe_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.STEM), "cantaloupe"));

		carrot_crop = register("carrot_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "carrot"));

		corn_crop = register("corn_crop", new DoubleCrop(Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
				.tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "corn"));

		cotton_crop = register("cotton_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "cotton"));

		cassava_crop = register("cassava_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "cassava"));

		cucumber_crop = register("cucumber_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "cucumber"));

		eggplant_crop = register("eggplant_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "eggplant"));

		honeydew_crop = register("honeydew_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "honeydew"));

		ginger_crop = register("ginger_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "ginger"));

		kenaf_crop = register("kenaf_crop", new DoubleCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "kenaf"));

		lettuce_crop = register("lettuce_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "lettuce"));

		oat_crop = register("oat_crop", new CustomCrop(Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
				.tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "oat"));

		onion_crop = register("onion_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "onion"));

		pea_crop = register("pea_crop", new CustomCrop(Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
				.tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "pea"));

		peanut_crop = register("peanut_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "peanut"));

		pepper_crop = register("pepper_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "pepper"));

		potato_crop = register("potato_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "potato"));

		radish_crop = register("radish_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "radish"));

		rice_crop = register("rice_crop", new CustomCrop(Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
				.tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "rice"));

		rye_crop = register("rye_crop", new CustomCrop(Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
				.tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "rye"));

		sorghum_crop = register("sorghum_crop", new DoubleCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "sorghum"));

		soybean_crop = register("soybean_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "soybean"));

		spinach_crop = register("spinach_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "spinach"));
		sweet_potato_crop = register("sweet_potato_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
		...
		zucchini_crop = register("zucchini_crop", new CustomCrop(Block.Properties.create(Material.PLANTS)
				.doesNotBlockMovement().tickRandomly().hardnessAndResistance(0).sound(SoundType.CROP), "zucchini"));

		wild_crop = register("wild_crop", new WildCrop(Block.Properties.create(Material.TALL_PLANTS)
