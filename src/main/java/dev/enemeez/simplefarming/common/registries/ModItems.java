...
public class ModItems {
    ...
    // Seed packets
    public static final RegistryObject<Item> FIBER_SEED_PACKET = registerSeedPacket("fiber_seed_packet", SeedPacketItem.Type.FIBER);
    public static final RegistryObject<Item> FRUIT_SEED_PACKET = registerSeedPacket("fruit_seed_packet", SeedPacketItem.Type.FRUIT);
    public static final RegistryObject<Item> GOURD_SEED_PACKET = registerSeedPacket("gourd_seed_packet", SeedPacketItem.Type.GOURD);
    public static final RegistryObject<Item> GRAIN_SEED_PACKET = registerSeedPacket("grain_seed_packet", SeedPacketItem.Type.GRAIN);
    public static final RegistryObject<Item> LEAFY_SEED_PACKET = registerSeedPacket("leafy_seed_packet", SeedPacketItem.Type.LEAFY);
    public static final RegistryObject<Item> LEGUME_SEED_PACKET = registerSeedPacket("legume_seed_packet", SeedPacketItem.Type.LEGUME);
    public static final RegistryObject<Item> ROOT_SEED_PACKET = registerSeedPacket("root_seed_packet", SeedPacketItem.Type.ROOT);
    public static final RegistryObject<Item> TUBER_SEED_PACKET = registerSeedPacket("tuber_seed_packet", SeedPacketItem.Type.TUBER);
    ...
    private static RegistryObject<Item> registerSeedPacket(String name, SeedPacketItem.Type type) {
        final RegistryObject<Item> ITEM = ITEMS.register(name, () -> new SeedPacketItem(new Item.Properties(), type));
        ITEM_LIST.add(ITEM);
        return ITEM;
    }
}
